...
class ContMateriaPrima(object):
    ...
    def riempi_labels(self, materiaprima: MateriaPrima):
        ...
        self.view.label_qtaDisp2.setText("Kg " + str(materiaprima.qta_disponibile))
        self.view.label_qtaLimite2.setText("Kg " + str(materiaprima.qta_limite))
        self.view.label_qtaOrdineSTD2.setText("Kg " + str(materiaprima.qta_ordine_STD))
