...
class VistaHomeAdmin(QWidget):
    ...
    def initUi(self):
        ...
        self.pulsante1 = crea_pulsante("Statistiche", "png/stats.png")
        self.pulsante2 = crea_pulsante("Magazzino", "png/magazzino.png")
        self.pulsante3 = crea_pulsante("Dipendenti", "png/dipendenti.png")
        self.pulsante4 = crea_pulsante("Turni", "png/turni.png")
        self.pulsante5 = crea_pulsante("Modifica Menu", "png/stats.png")
        self.pulsante6 = crea_pulsante("Prenotazioni", "png/stats.png")
        self.pulsante7 = crea_pulsante("Ricevute", "png/stats.png")
        ...
        griglia.addWidget(self.pulsante1, 1, 1)
        griglia.addWidget(self.pulsante2, 1, 2)
        griglia.addWidget(self.pulsante3, 2, 1)
        griglia.addWidget(self.pulsante4, 2, 2)
        griglia.addWidget(self.pulsante5, 3, 1)
        griglia.addWidget(self.pulsante6, 3, 2)
        griglia.addWidget(self.pulsante7, 4, 1, 1, 2, alignment=Qt.AlignmentFlag.AlignCenter)
