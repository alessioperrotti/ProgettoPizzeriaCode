...
class VistaVisualizzaDipendente(QDialog):
    def __init__(self):
        super().__init__()
        self.init_ui()
    ...
    def init_ui(self):
        ...
        self.campo_nome.setFont(label_font_piccolo)
        self.campo_cognome = QLabel()
        self.campo_cognome.setFont(label_font_piccolo)
        self.campo_email = QLabel()
        self.campo_email.setFont(label_font_piccolo)
        self.campo_data_nascita = QLabel()
        self.campo_data_nascita.setFont(label_font_piccolo)
        self.campo_data_ingaggio = QLabel()
        self.campo_data_ingaggio.setFont(label_font_piccolo)
        self.campo_stipendio = QLabel()
        self.campo_stipendio.setFont(label_font_piccolo)
        self.campo_ruolo = QLabel()
        self.campo_ruolo.setFont(label_font_piccolo)
        self.campo_username = QLabel()
        self.campo_username.setFont(label_font_piccolo)
        self.campo_password = QLabel()
        self.campo_password.setFont(label_font_piccolo)
        ...
        griglia_top.addWidget(self.campo_nome, 0, 1)
        griglia_top.addWidget(email, 0, 2)
        griglia_top.addWidget(self.campo_email, 0, 3)
        griglia_top.addWidget(cognome, 1, 0)
        griglia_top.addWidget(self.campo_cognome, 1, 1)
        griglia_top.addWidget(data_ingaggio, 1, 2)
        griglia_top.addWidget(self.campo_data_ingaggio, 1, 3)
        griglia_top.addWidget(ruolo, 2, 0)
        griglia_top.addWidget(self.campo_ruolo, 2, 1)
        griglia_top.addWidget(stipendio, 2, 2)
        griglia_top.addWidget(self.campo_stipendio, 2, 3)
        griglia_top.addWidget(data_nascita, 3, 0)
        griglia_top.addWidget(self.campo_data_nascita, 3, 1)

        griglia_bottom.addWidget(username, 0, 0)
        griglia_bottom.addWidget(self.campo_username, 0, 1)
        griglia_bottom.addWidget(password, 0, 2)
        griglia_bottom.addWidget(self.campo_password, 0, 3)
