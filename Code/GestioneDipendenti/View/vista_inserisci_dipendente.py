...
class VistaInserisciDipendente(QDialog):
    ...
    def init_ui(self):
        ...
        self.edit_nome.setFixedSize(287, 30)
        self.edit_cognome = QLineEdit()
        self.edit_cognome.setFixedSize(287, 30)
        self.edit_email = QLineEdit()
        self.edit_email.setFixedSize(287, 30)
        self.edit_stipendio = QLineEdit()
        self.edit_stipendio.setFixedSize(287, 30)
        self.edit_ruolo = QComboBox()
        self.edit_ruolo.addItem("Cuoco")
        self.edit_ruolo.addItem("Cameriere")
        self.edit_ruolo.setFixedSize(287, 30)
        self.edit_username = QLineEdit()
        self.edit_username.setFixedSize(287, 30)
        self.edit_password = QLineEdit()
        self.edit_password.setFixedSize(287, 30)

        self.pulsante = QPushButton("Conferma Inserimento")
        ...
        griglia_sx.addWidget(self.edit_nome, 1, 0)
        griglia_dx.addWidget(self.edit_cognome, 1, 1)
        ...
        griglia_sx.addWidget(self.edit_ruolo, 7, 0)
