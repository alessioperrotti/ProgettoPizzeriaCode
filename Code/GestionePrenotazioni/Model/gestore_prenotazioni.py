...
class GestorePrenotazioni():
    ...
    def stampa_lista_tavoli(self):
        ...
        for tavolo in self.lista_tavoli:
            print("numeroT: " + str(tavolo.numero) + " posti: " + str(tavolo.posti_disponibili) + " stato: " + str(
                tavolo.stato))
    ...
    def modifica_prenotazioni(self, codice_ricerca, new_tavolo, new_persone,
        ...
        for x in self.lista_prenotazioni:
            if int(pren_da_modificare.codice) == int(x.codice):
                x.tavolo_assegnato.cambia_stato("libero")
    ...
    def elimina_prenotazione(self, codice):
        ...
        prenotazione_da_eliminare.tavolo_assegnato.stato = "cambiato"
        print(prenotazione_da_eliminare.tavolo_assegnato.numero)
        print(prenotazione_da_eliminare.tavolo_assegnato.stato)
