...
from PyQt6.QtWidgets import (QDialog, QLabel, QPushButton, QVBoxLayout, QApplication, QSpacerItem,
...
class VistaMsgEliminaProdotto(QDialog):
    ...
    def initUI(self):
        # Definizione oggetti
        label1 = QLabel("<b>Sicuro di non volere altro?</b>")
        label1.setFont(label_font_piccolo)
        label2 = QLabel("Se sei soddisfatto così clicca su 'Sono sicuro'.\nIn cassa troverai qualcuno pronto ad accettare\nil pagamento ")
